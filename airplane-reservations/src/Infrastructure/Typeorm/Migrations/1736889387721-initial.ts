...
export class Initial1736889387721 implements MigrationInterface {
    name = 'Initial1736889387721'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."Seat_positioncolumn_enum" AS ENUM('A', 'B', 'C')`);
        ...
        await queryRunner.query(`CREATE TABLE "Flight" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), CONSTRAINT "PK_9426b759382ba6927a7013beb3f" PRIMARY KEY ("id"))`);
        await queryRunner.query(`CREATE TYPE "public"."Reservation_seatpositioncolumn_enum" AS ENUM('A', 'B', 'C')`);
        await queryRunner.query(`CREATE TABLE "Reservation" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "personId" uuid NOT NULL, "flightId" uuid, "seatPositionRow" integer NOT NULL, "seatPositionColumn" "public"."Reservation_seatpositioncolumn_enum" NOT NULL, CONSTRAINT "PK_7872a944b02ce511a96c8bcced1" PRIMARY KEY ("id"))`);
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`DROP TYPE "public"."Reservation_seatpositioncolumn_enum"`);
        await queryRunner.query(`DROP TABLE "Flight"`);
        await queryRunner.query(`DROP TABLE "Seat"`);
        await queryRunner.query(`DROP TYPE "public"."Seat_positioncolumn_enum"`);
    }
